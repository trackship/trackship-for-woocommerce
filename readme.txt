...
* Compatibility - Verified compatibility with WooCommerce version 9.8.4.
* Compatibility - Tested and confirmed compatibility with WordPress version 6.8.1.

= 1.9.3 - 2025-04-23 =
* Fix - Resolved an issue with saving shipment notification settings.
* Compatibility - Verified compatibility with WooCommerce version 9.8.2.
...
* Fix - Addressed an undefined variable issue on the tracking page.
* Update - Updated translations to ensure better language support.
* Improvement - Improved shipment length code for better accuracy and performance.
* Compatibility - Verified compatibility with WooCommerce version 9.7.1.
* Compatibility - Tested and verified compatibility with WordPress version 6.7.2.
...
* Update - tested up to WC versions for the WooCommerce 9.4.3 release

= 1.8.8 - 2024-11-13 =
* Fix - Translation issue with WordPress 6.7 fixed

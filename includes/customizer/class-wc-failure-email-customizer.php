...
class TSWC_Failure_Customizer_Email {
	...
	public function __construct() {
		...
		$this->defaults = trackship_admin_customizer()->wcast_shipment_settings_defaults( 'failure' );
	...
	public static function is_own_preview_request() {
		return isset( $_REQUEST['shipment-email-customizer-preview'] ) && 'failure' === $_REQUEST['status'];
	}
	...
	*/
	public function preview_failure_email() {
		...
		$wcast_show_product_image = trackship_for_woocommerce()->ts_actions->get_checkbox_option_value_from_array('wcast_failure_email_settings', 'wcast_failure_show_product_image', $this->defaults['wcast_failure_show_product_image']);
		...
		$shipment_status = trackship_admin_customizer()->get_wc_shipment_status_for_preview( 'failure', $preview_id );

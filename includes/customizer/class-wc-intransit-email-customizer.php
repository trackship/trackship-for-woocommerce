	...
	*/
	...
	public function wcast_register_sample_default_controls( $wp_customize ) {		
		...
		*/
		...
		$wp_customize->add_control( new TrackShip_Select_Custom_Control( $wp_customize, 'wcast_intransit_email_preview_order_id',
			array(
				'label' => __( 'Preview order', 'trackship-for-woocommerce' ),
				'description' => '',
				...
				'choices' => trackship_customizer()->get_order_ids(),
			)
		) );	
...
*/
$tswc_customizer_settings = new tswc_intransit_customizer_email();

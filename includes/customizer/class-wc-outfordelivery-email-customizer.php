	...
	*/	
	public function wcast_generate_defaults() {		
		$customizer_defaults = array(			
			'wcast_outfordelivery_email_subject' => __( 'Your order #{order_number} is out for delivery', 'trackship-for-woocommerce' ),
	...
	public function wcast_register_sample_default_controls( $wp_customize ) {		
		...
		*/
		...
		$wp_customize->add_control( 'wcast_outfordelivery_email_settings[wcast_enable_outfordelivery_email]',
			array(
				'label' => __( 'Enable Out For Delivery email', 'trackship-for-woocommerce' ),
				'description' => '',
		...
		$wp_customize->add_control( 'wcast_outfordelivery_email_settings[wcast_outfordelivery_email_subject]',
			array(
				...
				'input_attrs' => array(
					'class' => '',
					'style' => '',
					'placeholder' => __( $this->defaults['wcast_outfordelivery_email_subject'], 'trackship-for-woocommerce' ),
				),
				'active_callback' => array( $this, 'active_callback' ),
			)
		);
		...
		$wp_customize->add_control( 'wcast_outfordelivery_email_settings[wcast_outfordelivery_email_heading]',
			array(
				...
				'input_attrs' => array(
					'class' => '',
					'style' => '',
					'placeholder' => __( $this->defaults['wcast_outfordelivery_email_heading'], 'trackship-for-woocommerce' ),
				),
				'active_callback' => array( $this, 'active_callback' ),
			)
		);
		...
		$wp_customize->add_control( new TrackShip_TinyMCE_Custom_Control( $wp_customize, 'wcast_outfordelivery_email_settings[wcast_outfordelivery_email_content]',
			array(
				...
				'input_attrs' => array(
					...
					'mediaButtons' => true,
					'placeholder' => __( $this->defaults['wcast_outfordelivery_email_content'], 'trackship-for-woocommerce' ),
				),
				'active_callback' => array( $this, 'active_callback' ),
			)
		) );
		...
		$wp_customize->add_control( new TrackShip_Codeinfoblock_Control( $wp_customize, 'wcast_outfordelivery_email_settings[wcast_outfordelivery_email_code_block]',
			array(
		...
		$wp_customize->add_setting( 'wcast_outfordelivery_email_settings[analytics_heading]',
			array(
				'default' => '',
				'transport' => 'postMessage',
				'sanitize_callback' => '',
		...
		$wp_customize->add_control( new TrackShip_Heading_Control( $wp_customize, 'wcast_outfordelivery_email_settings[analytics_heading]',
			array(
	...
	public function active_callback_only_show_order_details() {
		...
		$show_order_details = trackship_for_woocommerce()->ts_actions->get_option_value_from_array('wcast_outfordelivery_email_settings', 'wcast_outfordelivery_show_order_details', $this->defaults['wcast_outfordelivery_show_order_details']);		
 ...
 */
new TSWC_Outfordelivery_Customizer_Email();

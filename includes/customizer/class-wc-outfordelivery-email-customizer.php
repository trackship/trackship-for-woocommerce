...
class TSWC_Outfordelivery_Customizer_Email {
	...
	public function __construct() {
		...
		$this->defaults = trackship_admin_customizer()->wcast_shipment_settings_defaults( 'outfordelivery' );
	...
	public static function is_own_preview_request() {
		return isset( $_REQUEST['shipment-email-customizer-preview'] ) && 'out_for_delivery' === $_REQUEST['status'];
	}
	...
	*/	
	public function preview_outfordelivery_email() {
		...
		$wcast_show_product_image = trackship_for_woocommerce()->ts_actions->get_checkbox_option_value_from_array('wcast_outfordelivery_email_settings', 'wcast_outfordelivery_show_product_image', $this->defaults['wcast_outfordelivery_show_product_image']);
		...
		$shipment_row = trackship_admin_customizer()->get_wc_shipment_row_for_preview( 'out_for_delivery', $preview_id );

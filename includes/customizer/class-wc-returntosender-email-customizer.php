...
class TSWC_Returntosender_Customizer_Email {
	...
	*/	
	public function preview_returntosender_email() {
		...
		$email_content = trackship_for_woocommerce()->ts_actions->get_option_value_from_array('wcast_returntosender_email_settings', 'wcast_returntosender_email_content', $this->defaults['wcast_returntosender_email_content']);
		...
		$wcast_returntosender_analytics_link = trackship_for_woocommerce()->ts_actions->get_option_value_from_array('wcast_returntosender_email_settings', 'wcast_returntosender_analytics_link', '');	
		...
		$shipment_status = trackship_admin_customizer()->get_wc_shipment_status_for_preview( 'return_to_sender', $preview_id );
 ...
 */
new TSWC_Returntosender_Customizer_Email();

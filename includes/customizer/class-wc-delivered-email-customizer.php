...
class TSWC_Delivered_Customizer_Email {
	...
	*/
	public function wcast_generate_defaults() {		
		$customizer_defaults = array(			
			'wcast_delivered_status_email_subject' => __( 'Your order #{order_number} has been delivered', 'trackship-for-woocommerce' ),
			'wcast_delivered_status_email_heading' => __( 'Delivered', 'trackship-for-woocommerce' ),
			'wcast_delivered_status_email_content' => __( "Hi there. we thought you'd like to know that your recent order from {site_title} has been Delivered.", 'trackship-for-woocommerce' ),'wcast_enable_delivered_status_email'  => '',
	...
	public function wcast_register_sample_default_controls( $wp_customize ) {		
		...
		*/
		...
		$wp_customize->add_control( 'wcast_delivered_email_settings[wcast_enable_delivered_status_email]',
			array(
				'label' => __( 'Enable Delivered email', 'trackship-for-woocommerce' ),
				'description' => '',
		...
		$wp_customize->add_control( 'wcast_delivered_email_settings[wcast_delivered_status_email_subject]',
			array(
				...
				'input_attrs' => array(
					'class' => '',
					'style' => '',
					'placeholder' => __( $this->defaults['wcast_delivered_status_email_subject'], 'trackship-for-woocommerce' ),
				),
				'active_callback' => array( $this, 'active_callback' ),
			)
		);
		...
		$wp_customize->add_control( 'wcast_delivered_email_settings[wcast_delivered_status_email_heading]',
			array(
				...
				'input_attrs' => array(
					'class' => '',
					'style' => '',
					'placeholder' => __( $this->defaults['wcast_delivered_status_email_heading'], 'trackship-for-woocommerce' ),
				),
				'active_callback' => array( $this, 'active_callback' ),
			)
		);
		...
		$wp_customize->add_control( new TrackShip_TinyMCE_Custom_Control( $wp_customize, 'wcast_delivered_email_settings[wcast_delivered_status_email_content]',
			array(
				...
				'input_attrs' => array(
					...
					'mediaButtons' => true,
					'placeholder' => __( $this->defaults['wcast_delivered_status_email_content'], 'trackship-for-woocommerce' ),
				),
				'active_callback' => array( $this, 'active_callback' ),
			)
		) );
		...
		$wp_customize->add_control( new TrackShip_Codeinfoblock_Control( $wp_customize, 'wcast_delivered_email_settings[wcast_delivered_status_email_code_block]',
			array(
		...
		$wp_customize->add_control( 'wcast_delivered_email_settings[wcast_delivered_status_show_tracking_details]',
			array(
				'label' => __( 'Show tracking details', 'trackship-for-woocommerce' ),
				'description' => '',
				'section' => 'trackship_shipment_status_email',
				'type' => 'checkbox',
				'active_callback' => array( $this, 'active_callback' ),
	...
	public function active_callback_only_show_order_details() {
		...
		$show_order_details = trackship_for_woocommerce()->ts_actions->get_option_value_from_array('wcast_delivered_email_settings', 'wcast_delivered_status_show_order_details', $this->defaults['wcast_delivered_status_show_order_details']);		
	...
	*/
	public function preview_delivered_email() {
		...
		$email_heading = trackship_for_woocommerce()->ts_actions->get_option_value_from_array('wcast_delivered_email_settings', 'wcast_delivered_status_email_heading', $this->defaults['wcast_delivered_status_email_heading']);		
		...
		$email_content = trackship_for_woocommerce()->ts_actions->get_option_value_from_array('wcast_delivered_email_settings', 'wcast_delivered_status_email_content', $this->defaults['wcast_delivered_status_email_content']);
		
		$wcast_show_tracking_details = trackship_for_woocommerce()->ts_actions->get_checkbox_option_value_from_array('wcast_delivered_email_settings', 'wcast_delivered_status_show_tracking_details', $this->defaults['wcast_delivered_status_show_tracking_details']);
		
		$wcast_show_order_details = trackship_for_woocommerce()->ts_actions->get_checkbox_option_value_from_array('wcast_delivered_email_settings', 'wcast_delivered_status_show_order_details', $this->defaults['wcast_delivered_status_show_order_details']);
		
		$wcast_show_shipping_address = trackship_for_woocommerce()->ts_actions->get_checkbox_option_value_from_array('wcast_delivered_email_settings', 'wcast_delivered_status_show_shipping_address', $this->defaults['wcast_delivered_status_show_shipping_address']);
		...
		$wcast_delivered_status_analytics_link = trackship_for_woocommerce()->ts_actions->get_option_value_from_array('wcast_delivered_email_settings', 'wcast_delivered_status_analytics_link', '');		
		...
		$shipment_status = trackship_customizer()->get_wc_shipment_status_for_preview( 'delivered' );

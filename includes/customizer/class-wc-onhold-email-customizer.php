...
class TSWC_Onhold_Customizer_Email {
	...
	*/
	public function wcast_generate_defaults() {		
		$customizer_defaults = array(			
			'wcast_onhold_email_subject' => __( 'Your order #{order_number} is on hold', 'trackship-for-woocommerce' ),
			'wcast_onhold_email_heading' => __( 'On Hold', 'trackship-for-woocommerce' ),
			'wcast_onhold_email_content' => __( "Hi there. we thought you'd like to know that your recent order from {site_title} is on hold", 'trackship-for-woocommerce' ),				
	...
	public function wcast_register_sample_default_controls( $wp_customize ) {		
		...
		*/
		...
		$wp_customize->add_control( 'wcast_onhold_email_settings[wcast_onhold_email_subject]',
			array(
				...
				'input_attrs' => array(
					'class' => '',
					'style' => '',
					'placeholder' => __( $this->defaults['wcast_onhold_email_subject'], 'trackship-for-woocommerce' ),
				),
				'active_callback' => array( $this, 'active_callback' ),
			)
		);
		...
		$wp_customize->add_control( 'wcast_onhold_email_settings[wcast_onhold_email_heading]',
			array(
				...
				'input_attrs' => array(
					'class' => '',
					'style' => '',
					'placeholder' => __( $this->defaults['wcast_onhold_email_heading'], 'trackship-for-woocommerce' ),
				),
				'active_callback' => array( $this, 'active_callback' ),
			)
		);
		...
		$wp_customize->add_control( new TrackShip_TinyMCE_Custom_Control( $wp_customize, 'wcast_onhold_email_settings[wcast_onhold_email_content]',
			array(
				...
				'input_attrs' => array(
					...
					'mediaButtons' => true,
					'placeholder' => __( $this->defaults['wcast_onhold_email_content'], 'trackship-for-woocommerce' ),
				),
				'active_callback' => array( $this, 'active_callback' ),
			)
		) );
		...
		$wp_customize->add_setting( 'wcast_onhold_email_settings[analytics_heading]',
			array(
				'default' => '',
				'transport' => 'postMessage',
				'sanitize_callback' => '',
		...
		$wp_customize->add_control( new TrackShip_Heading_Control( $wp_customize, 'wcast_onhold_email_settings[analytics_heading]',
			array(
	...
	*/
	public function preview_onhold_email() {
		...
		$shipment_status = trackship_customizer()->get_wc_shipment_status_for_preview( 'on_hold' );

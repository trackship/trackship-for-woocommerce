...
class TSWC_Availableforpickup_Customizer_Email {
	...
	*/
	public function preview_availableforpickup_email() {
		...
		$wcast_show_product_image = trackship_for_woocommerce()->ts_actions->get_checkbox_option_value_from_array('wcast_availableforpickup_email_settings', 'wcast_availableforpickup_show_product_image', $this->defaults['wcast_availableforpickup_show_product_image']);
		...
		$shipment_status = trackship_admin_customizer()->get_wc_shipment_status_for_preview( 'available_for_pickup', $preview_id );

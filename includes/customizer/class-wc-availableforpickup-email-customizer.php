...
class TSWC_Availableforpickup_Customizer_Email {
	...
	*/
	public function wcast_generate_defaults() {		
		$customizer_defaults = array(			
			'wcast_availableforpickup_email_subject' => __( 'Your order #{order_number} is available for pickup', 'trackship-for-woocommerce' ),
			'wcast_availableforpickup_email_heading' => __( 'Available For Pickup', 'trackship-for-woocommerce' ),
			'wcast_availableforpickup_email_content' => __( "Hi there. we thought you'd like to know that your recent order from {site_title} is available for pickup.", 'trackship-for-woocommerce' ),				
	...
	public function wcast_register_sample_default_controls( $wp_customize ) {		
		...
		*/
		...
		$wp_customize->add_control( 'wcast_availableforpickup_email_settings[wcast_enable_availableforpickup_email]',
			array(
				'label' => __( 'Enable Available For Pickup email', 'trackship-for-woocommerce' ),
				'description' => '',
		...
		$wp_customize->add_control( 'wcast_availableforpickup_email_settings[wcast_availableforpickup_email_subject]',
			array(
				...
				'input_attrs' => array(
					'class' => '',
					'style' => '',
					'placeholder' => __( $this->defaults['wcast_availableforpickup_email_subject'], 'trackship-for-woocommerce' ),
				),
				'active_callback' => array( $this, 'active_callback' ),
			)
		);
		...
		$wp_customize->add_control( 'wcast_availableforpickup_email_settings[wcast_availableforpickup_email_heading]',
			array(
				...
				'input_attrs' => array(
					'class' => '',
					'style' => '',
					'placeholder' => __( $this->defaults['wcast_availableforpickup_email_heading'], 'trackship-for-woocommerce' ),
				),
				'active_callback' => array( $this, 'active_callback' ),
			)
		);
		...
		$wp_customize->add_control( new TrackShip_TinyMCE_Custom_Control( $wp_customize, 'wcast_availableforpickup_email_settings[wcast_availableforpickup_email_content]',
			array(
				...
				'input_attrs' => array(
					...
					'mediaButtons' => true,
					'placeholder' => __( $this->defaults['wcast_availableforpickup_email_content'], 'trackship-for-woocommerce' ),
				),
				'active_callback' => array( $this, 'active_callback' ),
			)
		) );				
		...
		$wp_customize->add_control( new TrackShip_Codeinfoblock_Control( $wp_customize, 'wcast_availableforpickup_email_settings[wcast_availableforpickup_email_code_block]',
			array(
		...
		$wp_customize->add_setting( 'wcast_availableforpickup_email_settings[analytics_heading]',
			array(
				'default' => '',
				'transport' => 'postMessage',
				'sanitize_callback' => '',
		...
		$wp_customize->add_control( new TrackShip_Heading_Control( $wp_customize, 'wcast_availableforpickup_email_settings[analytics_heading]',
			array(
	...
	public function active_callback_only_show_order_details() {
		...
		$show_order_details = trackship_for_woocommerce()->ts_actions->get_option_value_from_array('wcast_availableforpickup_email_settings', 'wcast_availableforpickup_show_order_details', $this->defaults['wcast_availableforpickup_show_order_details']);		
	...
	public function set_up_preview() {
		...
		include trackship_for_woocommerce()->get_plugin_path() . '/includes/customizer/preview/availableforpickup_preview.php';		
		exit;			
	}
	...
	*/
	public function preview_availableforpickup_email() {
		...
		$email_heading = trackship_for_woocommerce()->ts_actions->get_option_value_from_array('wcast_availableforpickup_email_settings', 'wcast_availableforpickup_email_heading', $this->defaults['wcast_availableforpickup_email_heading']);	
		...
		$email_content = trackship_for_woocommerce()->ts_actions->get_option_value_from_array('wcast_availableforpickup_email_settings', 'wcast_availableforpickup_email_content', $this->defaults['wcast_availableforpickup_email_content']);
		
		$wcast_show_order_details = trackship_for_woocommerce()->ts_actions->get_checkbox_option_value_from_array('wcast_availableforpickup_email_settings', 'wcast_availableforpickup_show_order_details', $this->defaults['wcast_availableforpickup_show_order_details']);	
		
		$wcast_show_shipping_address = trackship_for_woocommerce()->ts_actions->get_checkbox_option_value_from_array('wcast_availableforpickup_email_settings', 'wcast_availableforpickup_show_shipping_address', $this->defaults['wcast_availableforpickup_show_shipping_address']);		
		...
		$wcast_availableforpickup_analytics_link = trackship_for_woocommerce()->ts_actions->get_option_value_from_array('wcast_availableforpickup_email_settings', 'wcast_availableforpickup_analytics_link', '');	
		...
		$shipment_status = trackship_customizer()->get_wc_shipment_status_for_preview( 'available_for_pickup' );
...
*/
new TSWC_Availableforpickup_Customizer_Email();

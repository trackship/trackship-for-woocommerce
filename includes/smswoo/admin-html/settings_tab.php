	...
	<div class="heading_panel section_sms_heading">
		...
		<?php if ( ! function_exists( 'SMSWOO' ) && ! is_plugin_active( 'zorem-sms-for-woocommerce/zorem-sms-for-woocommerce.php' ) ) { ?>
			<div class="heading_panel_save">
				...
				<button name="save" class="button button-trackship trackship-save-button button-smswoo" type="submit"><?php esc_html_e( 'Save changes', 'trackship-for-woocommerce' ); ?></button>
		...
		<?php if ( function_exists( 'SMSWOO' ) || is_plugin_active( 'zorem-sms-for-woocommerce/zorem-sms-for-woocommerce.php' ) ) { ?>
			<div class="ts-plugin-redirect-card">
				...
				<div class="ts-plugin-redirect-card__body">
					...
					<a href="<?php echo esc_url( admin_url( 'admin.php?page=sms-for-woocommerce&tab=settings' ) ); ?>" class="button button-trackship ts-plugin-redirect-card__btn">

...
$placeholders = array( '{shop_name}', '{order_id}', '{order_count}', '{order_amount}', '{billing_name}', '{billing_first}', '{billing_last}', '{shipping_name}', '{shipping_first}', '{shipping_last}', '{tracking_number}', '{tracking_provider}', '{tracking_link}' );

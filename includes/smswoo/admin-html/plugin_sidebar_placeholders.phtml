...
<div class="zorem_plugin_sidebar_section">
	<div class="zorem_plugin_sidebar_section_header">
		<h3><?php _e('Available placeholders', 'trackship-for-woocommerce' ) ?></h3>
	</div>
	<div class="zorem_plugin_sidebar_section_content">

		<p>
        	<?php foreach( $placeholders as $placeholder ){?>
                <code class="btn clipboard placeholder" title='copied!' data-clipboard-text='<?php echo $placeholder?>' >
					<?php echo $placeholder?>
				</code>
            <?php } ?>
            <br>
			<a href="https://www.zorem.com/docs/sms-for-woocommerce/sms-notifications/#available-placeholders-for-orders-sms" target="_blank"><?php _e('More info', 'trackship-for-woocommerce' ) ?></a>
		</p>
	</div>
</div>

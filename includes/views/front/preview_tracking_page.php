...
<div class="tracking-detail col">
    <div class="shipment-content">
            ...
            <div class="tracking_number_wrap">
            	<span class="wc_order_id">
                    <a href="#" target="_blank">
                        <?php printf( __( 'Order #%d', 'trackship-for-woocommerce' ), 14696 ); ?>
                    </a>
                </span>

                <div class="provider_image_div" style="">
                    <img class="provider_image" src="<?php echo trackship_for_woocommerce()->plugin_dir_url()?>assets/images/usps.png?v=3.1.1">
                </div>
        ...
        <div class="tracking-details" style="<?php if($hide_tracking_events == 1){ echo 'display:none'; } ?>">
            ...
            <?php } elseif( $hide_tracking_events == 2 ){ ?>
                ...
                <a class="view_old_details" href="javaScript:void(0);" style="display: inline;"><?php _e( 'view more', 'trackship-for-woocommerce' ); ?></a>
                <a class="hide_old_details" href="javaScript:void(0);" style="display: none;"><?php _e( 'view less', 'trackship-for-woocommerce' ); ?></a>		
            <?php } ?>
	...
	<div class="trackship_branding" >
        <p>
        	<a href="https://trackship.info" title="TrackShip" target="blank"><img src="<?php echo trackship_for_woocommerce()->plugin_dir_url()?>assets/images/trackship-logo.png"></a>
        </p>
    </div>

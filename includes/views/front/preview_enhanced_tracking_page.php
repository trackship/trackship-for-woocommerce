<style>	
	...
	<?php } ?>
	<?php if ( in_array( get_option( 'user_plan' ), array( 'Complimentary 100', 'Complimentary 150', 'Free 20', 'No active plan', 'Trial Ended' ) ) && 'classic' == $tracking_page_type ) { ?>
		.enhanced_trackship_branding{display:none;}
	<?php } elseif ( in_array( get_option( 'user_plan' ), array( 'Complimentary 100', 'Complimentary 150', 'Free 20', 'No active plan', 'Trial Ended' ) ) ) { ?>

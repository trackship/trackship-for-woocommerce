<style>	
	...
	<?php } ?>
	<?php if ( in_array( get_option( 'user_plan' ), array( 'Free 50', 'No active plan', 'Trial Ended' ) ) && 'classic' == $tracking_page_type ) { ?>
		.enhanced_trackship_branding{display:none;}
	<?php } elseif ( in_array( get_option( 'user_plan' ), array( 'Free 50', 'No active plan', 'Trial Ended' ) ) ) { ?>

        ...
        <tbody>
          ...
          <tr>
            <td class="license_number">
                <input name="license_key" size="50" type="text" class="textfield license_key" value="<?php echo $license->get_license_key(); ?>" required placeholder="<?php esc_html_e( 'License Key', 'trackship-for-woocommerce' ); ?>" />
                ...
                <input type="submit" class="button-primary licence_submit button-trackship" name="licence_submit" value="<?php echo $license->get_license_status() ? __( 'Deactivate' ) : __( 'Activate' ); ?>">

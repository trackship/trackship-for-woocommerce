	...
	<div class="outer_form_table">
		<table class="form-table heading-table">
			<tbody>				
				<tr valign="top">
					<td>
						<h3 style=""><?php esc_html_e( 'General Settings', 'trackship-for-woocommerce' ); ?></h3>
					</td>
					<td>
...
<form method="post" id="wc_ast_trackship_automation_form" action="" enctype="multipart/form-data">
	<div class="outer_form_table">	
		...
		<table class="form-table order-status-table">
			<tbody>					
						<tr valign="top" class="delivered_row <?php echo !get_option( 'wc_ast_status_delivered' ) ? 'disable_row' : ''; ?> ">
							<td class="forminp"> 

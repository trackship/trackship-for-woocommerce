...
<?php if ( trackship_for_woocommerce()->is_trackship_connected() ) { ?>
	<?php /*?><div class="flexcontainer">
        ...
        <div class="flexcolumn right_border fullfillment_counter"> 
            <strong class="active_shipments_count"><?php echo esc_html( $tracking_analytics['active_shipments'] ); ?><span class="percentage active_shipments_percent"><?php echo esc_html( $tracking_analytics['active_shipments_percent'] ); ?></span></strong>
        ...
        <div class="flexcolumn right_border fullfillment_counter"> 
            ...
            <span class="percentage delivered_shipments_percent"><?php echo esc_html( $tracking_analytics['delivered_shipments_percent'] ); ?></span>
            <span style="color: #59c889; display:block;">Delivered</span>
        </div>

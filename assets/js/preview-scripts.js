( function( $ ) {
	...
	wp.customize( 'wc_ast_select_font_color', function( value ) {
		value.bind( function( to ) {
			$( 'body .tracking-detail .shipment-content, body .tracking-detail .shipment-content h4' ).css( 'color', to );
		});
	});
	...
	wp.customize( 'wc_ast_remove_trackship_branding', function( value ) {		
		value.bind( function( to ) {
			if( to ){
				$( '.trackship_branding' ).hide();
			}	
